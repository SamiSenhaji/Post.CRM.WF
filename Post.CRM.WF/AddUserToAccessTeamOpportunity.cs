...
namespace Post.CRM.WF
{
    ...
    public class AddUserToAccessTeamOpportunity : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            tracer.Trace(Opportunity.Get(executionContext).Id.ToString());
            ...
            try
            {
                ...
                adduser.Record = Opportunity.Get(executionContext);
